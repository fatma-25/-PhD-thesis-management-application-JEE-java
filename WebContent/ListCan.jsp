				...
				<div class="x_content">
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    <tbody>
                      ...
                      <c:forEach var="M" items="${lstc }">
                      <tr class="odd pointer">
                        <td class="a-center ">
                          <input type="checkbox" class="tableflat">
                        </td>
                          <td class=" "><img alt="" src="http://127.0.0.1/uploads/${M.photo }"  width="70" hight="70"></td>
                        <td class=" ">${M.idC }</td>
                        <td class=" ">${M.nom }</td>
                      ...
                      <td class=" last"><a href="#"> 
					  				     <a href="Index?can=importdoc&idx=${M.idC }" type="submit" class="btn btn-success dropdown-toggle btn-xs"><i class="fa fa-folder"></i>Import</a>
                          <a href="Index?can=showCan&id=${M.idC }" type="submit" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>Cons</a>
                          <a href="Index?can=modCan&id=${M.idC }" type="submit" class="btn btn-info btn-xs"><i class="fa fa-pencil" name="can" value="Modifier"></i> Modif </a>
                          <a href="Index?can=delete&IDd=${M.idC}" type="submit" class="btn btn-danger btn-xs" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette entrée?'));"><i class="fa fa-trash-o"></i> Supp </a>
                       </td>
                        </td>
                      </tr>
                        </c:forEach>
