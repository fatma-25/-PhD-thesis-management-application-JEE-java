          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:600px;">
                ...
                <div class="x_title">
                  <h2>Liste des Théses déposée</h2>
                  ...
                  <c:forEach var="D" items="${lstc2 }">
                     <tr class="odd pointer">
                        <td class="a-center ">
						  ...
						  <td class=" ">${D.thesedepose.date }</td>
						 
                       
                         <td class=" last"><a href="#"> 
                         <c:if test="${D.result_observation == 'Plus'}">
 						    <a href="Index?can=thesesoutenue&idd=${D.idOb }&idtt=${D.thesedepose.these.id_these }" type="submit" class="btn btn-success dropdown-toggle btn-xs"><i class="fa fa-folder"></i>traiter thése soutenue</a>
