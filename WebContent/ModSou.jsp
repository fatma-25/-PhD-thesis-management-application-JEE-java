          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:600px;">
                <div class="x_title">
                  <h2>Modification thése soutenu</h2>
                   
                  <div class="clearfix"></div>
                </div>
				<div class="x_content">
				 <form method="post" class="form-horizontal form-label-left"  novalidate action="Index?id3=${USER3.idD}">
             ...
             <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="date" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="${USER3.date}" name="date" required="required" type="date">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <a href="Index?can=list3" type="submit" class="btn btn-primary">Retourner</a>
                        <button id="send" type="submit" class="btn btn-success" name="can" value="Modifier3">Modifier</button>
                      </div>
                    </div>
                  </form>
				</div>
