				...
				<form method="post" class="form-horizontal form-label-left"  novalidate action="Index">
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="nom" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="prenom" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
					 ...
					 <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="number" name="tel" required="required" data-validate-minmax="8" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="lieu" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="grade" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-3">
                        ...
                        <button id="send" type="submit" class="btn btn-success" name="can" value="ajouter">Ajouter</button>
                      </div>
                    </div>
                  </form>
				</div>
