          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:600px;">
				...
				<div class="x_content">
				 <form method="post" class="form-horizontal form-label-left"  novalidate action="Index?ID=${USER12.id}">
                      ...
                      <center><label class="form-control col-md-7 col-xs-12" for="name" value="" type="nom">Nom:${USER12.nom}<span class="required"></span>
                      </label></center>
                      
                  
					
					  
                      <center><label class="form-control col-md-7 col-xs-12" for="name" value="" type="prenom">Prenom: ${USER12.prenom}<span class="required"></span>
                      </label></center>
                      ...
                      <center><label class="form-control col-md-7 col-xs-12" for="email" value="" type="email">Email:${USER12.email} <span class="required">*</span>
                      </label></center>
                      
                  
					
					
                      <center><label class="form-control col-md-7 col-xs-12" for="number" value="" type="tel">Tel:${USER12.tel}<span class="required">*</span>
                      </label></center>
                      ...
                      <center><label class="form-control col-md-7 col-xs-12" for="name" value="" type="encadreur">grade:${USER12.grade}<span class="required">*</span>
                      </label></center>
                      
                 
					
					 <center><label class="form-control col-md-7 col-xs-12" for="name" value="" type="encadreur">lieu:${USER12.lieu}<span class="required">*</span>
                      </label></center>
                   ...
                   <div class="ln_solid"></div>
                    <div class="form-group">
                     ...
                     <center> <a href="Index?can=list1" type="submit" class="btn btn-primary">Retourner</a></center>
