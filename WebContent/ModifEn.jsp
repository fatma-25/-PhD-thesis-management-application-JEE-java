          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:600px;">
                <div class="x_title">
                  <h2>Mettre à jour thèse</h2>
                   
                  <div class="clearfix"></div>
                </div>
				<div class="x_content">
				 <form method="post" class="form-horizontal form-label-left"  novalidate action="Index?idc=${USER15.candidat.idC }&id_these=${USER15.id_these}">

                   
           
                        <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">cin/passeport<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="${USER15.candidat.idC}" name="idC" placeholder="both name(s) e.g Jon Doe" required="required" type="text" disabled>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="${USER15.titre}" name="titre" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <textarea class="resizable_textarea form-control" value="${USER15.description}" name="description" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 74px;" data-autosize-on="true">
                    </textarea>
                  </div>
                </div>
                   ...
                   <a href="Index?can=list1" type="submit" class="btn btn-primary">Retourner</a>
                        <button id="send" type="submit" class="btn btn-success" name="can" value="ModifierEN">Modifier</button>
