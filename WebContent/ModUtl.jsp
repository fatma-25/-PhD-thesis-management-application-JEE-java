      ...
      <!-- page content -->
        ...
        <div class="">
          <div class="page-title">
            ...
            <h2>Modification Droits d'Accès</h2>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:600px;">
				...
				<div class="x_content">
				 <form method="post" class="form-horizontal form-label-left"  novalidate action="Index?idd=${utl.id}">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="${utl.nom}" name="nom" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="${utl.prenom}" name="prenom" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
					
					  <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">motpasse<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="${utl.password}" name="password" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="${utl.login}" name="login" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                      </div>
                    </div>
                   ...
                   <a href="Index?can=list7" type="submit" class="btn btn-primary">Retourner</a>
                        <button id="send" type="submit" class="btn btn-success" name="can" value="Modifierutl">Modifier</button>
                      </div>
                    </div>
                  </form>
				</div>
