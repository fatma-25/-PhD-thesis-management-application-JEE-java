              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i>Gestion Enseingnants<span class="fa fa-chevron-down"></span></a>
                 ...
                 <li><a><i class="fa fa-edit"></i>Gestion These <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
					<li><a href="then.jsp">Inscrire These</a>
                    </li>
                  ...
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    <tbody>
                      ...
                      <td class=" last"><a href="#"> 
					  				     <a href="Index?can=goaddThese&id=${M.id_these }" type="submit" class="btn btn-success dropdown-toggle btn-xs"><i class="fa fa-folder"></i>traiter thése déposée</a>
                                              <a href="Index?can=modEn&idthese=${M.id_these }" type="submit" class="btn btn-info btn-xs"><i class="fa fa-pencil" name="can" value="Modifier"></i> Modif </a>
                       </td>
                        </td>
                      </tr>
                        </c:forEach>
