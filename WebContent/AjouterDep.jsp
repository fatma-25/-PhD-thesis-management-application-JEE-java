          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:600px;">
				...
				<div class="x_content">
		 <form method="post" class="form-horizontal form-label-left"  novalidate action="Index?idthese=${THESEE }">
...
<h1>${MSG }</h1>
					...
					<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="date" class="form-control col-md-7 col-xs-12" value="${DAT }" data-validate-length-range="6" data-validate-words="2" name="datedep" required="required" type="date">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-3">
						...
						<center> <button id="send" type="submit"  class="btn btn-success" name="can" value="ValidObservaton">Valider</button></a></center>
                      </div>
                    </div>
