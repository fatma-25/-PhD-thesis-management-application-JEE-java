            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel" style="height:600px;">
				...
				<div class="x_content">
                  ...
                  <e:forEach var="E" items="${lstc1 }">
                     <tr class="odd pointer">
                        <td class="a-center ">
                          <input type="checkbox" class="tableflat">
                        </td>
                        <td class=" ">${E.nom }</td>
                          <td class=" ">${E.prenom }</td>
				
							<td class=" ">${E.grade }   </td>
                         <td class=" last"><a href="#"> 

                          <a href="Index?can=showEns&id1=${E.id }" type="submit" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>Cons</a>
                          <a href="Index?can=modEns&id1=${E.id }" type="submit" class="btn btn-info btn-xs"><i class="fa fa-pencil" name="can" value="Modifier"></i> Modif </a>
                          <a href="Index?can=delete1&IDd1=${E.id}" type="submit" class="btn btn-danger btn-xs" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette entrée?'));"  ><i class="fa fa-trash-o"></i> Supp </a>
                       </td>
                      </tr>
                      </e:forEach>
                    </tbody>
